...
const Header = () => {
    ...
    return (
        <header className={clsx('fixed top-0 left-0 w-full z-50 py-10 max-lg:py-4 transition-all duration-500', hasScrolled && 'bg-black-100 py-2 backdrop-blur-[8px]')} >
            <div className='container flex h-14 items-center max-lg:px-5' >
                <a href="" className='lg:hidden flex-1 cursor-pointer z-2' >
                    <img src="/images/xora.svg" width={115} height={55} alt="LOGO" />
                </a>
                <div className={clsx("w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:opacity-0 max-lg:bg-s2", isOpen ? 'max-lg:opacity-100' : 'max-lg:pointer-events-none')}>
                    <div className='max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before' >
                        <nav className="max-lg:relative max-lg:my-auto max-lg:z-2 max-md:px-4" >
                ...
                <button className="lg:hidden z-2 size-10 border-2 border-s4/25 rounded-full flex justify-center items-center" >
                    <img
                        ...
                        src={`/images/${isOpen ? 'close' : 'magic'}.svg`} alt="magic" className="size-1/2 object-contain" />
                </button>
            </div>
        </header>
    )
